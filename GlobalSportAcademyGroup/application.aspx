                  ...
                  <span class='amount'>$300</span>
                        ...
                        <div class='form-row'>
                            <div class='col-md-12 form-group'>
                                <asp:Button runat="server" CssClass='form-control btn btn-primary submit-button' Text="Submit Application »" ID="btnSubmit" onClientclick="validateForm()" OnClick="btnSubmit_Click"></asp:Button>
                            </div>
                        </div>
                        <div class='form-row'>
