...
namespace GlobalSportAcademyGroup.classes
{
    ...
    {
        public static bool MailSendSharedArticleNotificationToParent(StudentRecord studentRecord)
        {
            try
            {
                ...
                body += "           <a href=\"" + ClsGlobalscs.WebsiteURL + "\"><img alt=\"logo\" src=\"" + ClsGlobalscs.WebsiteURL + "/img/GSAG_Logo.png\" style=\"float:right;\"></a>";
                body += "         </td>";
